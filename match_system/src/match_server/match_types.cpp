...
void User::__set_names(const std::string& val) {
  this->names = val;
}
    ...
    switch (fid)
    {
      ...
      case 2:
        if (ftype == ::apache::thrift::protocol::T_STRING) {
          xfer += iprot->readString(this->names);
...
uint32_t User::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("names", ::apache::thrift::protocol::T_STRING, 2);
  xfer += oprot->writeString(this->names);
  xfer += oprot->writeFieldEnd();
